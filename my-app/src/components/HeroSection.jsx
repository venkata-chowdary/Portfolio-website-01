...
export function HeroSection() {
    return (
        <div className="ml-4 px-2 lg:px-6 lg:max-w-6xl lg:mx-auto flex flex-col mt-28 lg:mt-12 lg:mb-24">
            <h1 className=" lg:-ml-2 text-[2.7rem] lg:text-9xl font-bold tracking-tighter leading-none">Venkata Chowdary</h1>
            <h3 className=" text-2xl lg:text-6xl mt-3 lg:mt-4 font-normal opacity-80 leading-tight w-3/5">I build tech, debug life, deploy dreams!</h3>
