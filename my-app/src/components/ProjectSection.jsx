    ...
    const projectsData = [
        {
            ...
            description: "I built this platform to simulate real technical interviews and give candidates detailed feedback instantly. It uses resume-aware question selection with embeddings and Qdrant, supports both voice and text responses, and runs a structured LLM evaluation pipeline for scoring and reports. FastAPI background workers plus Redis caching helped cut response latency by about 40%.",
            technologies: ["FastAPI", "LangChain", "Qdrant", "PostgreSQL", "Redis", "Gemini Embeddings", "Web Speech API"],
        ...
        },
        {
            ...
            description: "Trackly started as a way to solve the chaos of job hunting. It pulls application emails from Gmail, uses AI to classify them, and organizes status, deadlines, and job details in one clean dashboard. I built it with Next.js, Prisma, and Clerk to keep the experience fast, secure, and easy to use.",
        ...
        {
            title: "ConnectNow",
            description: "ConnectNow is a real-time chat app focused on making conversations feel live and smooth. It supports instant messaging, group chats, and peer-to-peer video calls, along with features like typing indicators, read receipts, and emoji reactions. I also added OTP and JWT-based auth for secure onboarding and account flows.",
        ...
        {
            title: "Task Notifier",
            description: "Task Notifier is a MERN-based task manager for planning day-to-day work without friction. Users can create tasks, set reminders, assign priorities, and organize activities by category. I included authentication, alerting, and sharing features so it works for both personal tracking and lightweight collaboration.",
